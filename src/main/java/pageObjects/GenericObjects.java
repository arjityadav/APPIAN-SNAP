...
public class GenericObjects extends BaseClass {
    ...
    public void login() {
        ...
        signinBtn.click();
        appianFeature.waitForWorking();
        Report.logEvent("pass", "Login Successful");
    }

    public void clickOnButton(String strButton) {
        appianFeature.clickOnButton(strButton);
        appianFeature.waitForProgressBar();
    ...
    public boolean verifyTextIsPresent(String strText) {
        ...
        appianFeature.waitForSeconds(2);
    ...
    public void clickOnSitePage(String strSitePageName){
        appianFeature.clickOnSitePage(strSitePageName);
